        ...
        <nav class="navbar navbar-expand-lg bg-white navbar-light py-3 py-lg-0 px-lg-5">
            ...
            <div class="collapse navbar-collapse justify-content-between px-lg-3" id="navbarCollapse">
                <div class="navbar-nav mx-auto py-0">
                    ...
                    <a href="Enquiries.jsp" class="nav-item nav-link active">Enquiries</a>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <div class="section-title position-relative mb-4">
                        <h6 class="d-inline-block position-relative text-secondary text-uppercase pb-2">View User Enquiries</h6>
                    ...
                    <div class="contact-form">
                            ...
                            <table id="alter" align="center">  
								<tr>
									...
									<th>Services</th>
									<th>Email Id</th>
									<th>Appiointment Date</th>
									<th>Appiointment Time</th>
									<th>User Message</th>
								</tr>   					
						<%
						int srno=0;
