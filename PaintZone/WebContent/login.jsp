...
<html lang="en">
  ...
  <body>
    ...
    <div class="wrap">
	    ...
	    <div class="container">
	    	<a class="navbar-brand" href="login.jsp">Paint<span>CRAFT</span></a>
	      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#ftco-nav" aria-controls="ftco-nav" aria-expanded="false" aria-label="Toggle navigation">
	        <span class="fa fa-bars"></span> Menu
	      </button>
	      <div class="collapse navbar-collapse" id="ftco-nav">
	        <ul class="navbar-nav ml-auto">
	        	<li class="nav-item active"><a href="login.jsp" class="nav-link">User</a></li>
        ...
        <div class="row no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate">
          	...
          	<form action="Login" method="post">
            	<div class="row">
                	<div class="col-4 form-group"><h3 style="color:white"><b>UserName</b></h3></div>
                	<div class="col-4 form-group">
                    	<input type="text" name="uname" class="form-control border-top-0 border-right-0 border-left-0 p-0" placeholder="     Enter UserName" required="required">
                    </div>                                
                </div>
                            
                <div class="row">
                	<div class="col-4 form-group"><h3 style="color:white"><b>Password</b></h3></div>
                    	<div class="col-4 form-group">
                        	<input type="password" name="pwd" class="form-control border-top-0 border-right-0 border-left-0 p-0" placeholder="     Enter Password" required="required">
                        </div>
                </div>
                          
                <div align="left">
                	<button class="btn btn-primary py-3 px-5" type="submit" value="Login"><b>Login</b></button>&nbsp;
                    	<a href="Registration.jsp" style="color: blue;" class="btn btn-primary py-3 px-5"><font color="White"><b>New Registration</b></font></a>
                </div>                   
			</form>
