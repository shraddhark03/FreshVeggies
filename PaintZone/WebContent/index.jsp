...
<html lang="en">
  ...
  <body>
	<%
		if(request.getParameter("logdone")!=null)
		{
			out.println("<script>alert('User Login Successful')</script>");
		}
		if(request.getParameter("Done")!=null)
		{
			out.println("<script>alert('User Enquery Send Successfull')</script>");
		}
	%>
    <div class="wrap">
			<div class="container">
      ...
      <div class="container">
        <div class="row no-gutters slider-text align-items-center justify-content-end" data-scrollax-parent="true">
          <div class="col-md-6 ftco-animate">
          	<h1 class="mb-4">Welcome&nbsp;&nbsp;<span><%=session.getAttribute("fname") %>&nbsp;<%=session.getAttribute("lname") %></span></h1>
          	<h1 class="mb-4">Professional <span>Coloring</span> <span>Coating</span> Services</h1>
    	...
    	<div class="container">
    		<div class="row d-md-flex justify-content-center">
    			<div class="col-md-12 col-lg-8 half p-3 py-5 pl-lg-5 ftco-animate">
    				...
    				<form action="Enquiry" method="post" class="appointment">
    					<div class="row">
    						<div class="col-md-12">
	                      ...
	                      <select name="services" id="services" class="form-control">
	                        ...
	                        <option value="">Floor Painting</option>
				              ...
				              <input type="text" name="uname" class="form-control" value="<%=session.getAttribute("fname") %> <%=session.getAttribute("lname") %>">
				            </div>
			            </div>
								</div>
								<div class="col-md-6">
				              ...
				              <input type="text" name="email" class="form-control" value="<%=session.getAttribute("email") %>" placeholder="Email Address">
			            		...
			            		<input type="text" name="apdate" class="form-control appointment_date" placeholder="Date">
		            		</div>
			    				</div>
								</div>
								<div class="col-md-6">
			            		...
			            		<input type="text" name="aptime" class="form-control appointment_time" placeholder="Time">
		            		</div>
			    				</div>
								</div>
								<div class="col-md-12">
