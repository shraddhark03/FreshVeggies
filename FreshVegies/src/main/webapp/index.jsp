...
<body>
	...
	<div class="header-bot">
		<div class="container">
			<div class="col-md-3 header-left">
				<h3>
					<a href="index.jsp">Fresh Veggies<img class="img-responsive" src="images/logo.jpg"
						 /></a>
				</h3>
			</div>
		...
		<div id="visual">
			<div class="slide-visual">
				...
				<ul class="slide-group">
					<li><img class="img-responsive" src="images/veg1.jpg"
						alt="Dummy Image" /></li>
					<li><img class="img-responsive" src="images/veg2.jpeg"
						alt="Dummy Image" /></li>
					<li><img class="img-responsive" src="images/veg3.jpeg"
						alt="Dummy Image" /></li>
				</ul>
		...
		<!-- 		<div class="script-wrap">
					<ul class="script-group">
						<li><div class="inner-script">
								<img class="img-responsive" src="images/veg1.jpg"
									alt="Dummy Image" />
							</div></li>
						<li><div class="inner-script">
								<img class="img-responsive" src="images/veg2.jpeg"
									alt="Dummy Image" />
							</div></li>
						<li><div class="inner-script">
								<img class="img-responsive" src="images/veg3.jpeg"
									alt="Dummy Image" />
							</div></li>
					</ul>
	...
	<div class="product-easy">
		<div class="container">
			<div class="container">
				<h2>
					<span><center>All Vegetables and fruits</center></span>
				</h2>
			</div>
			<%
